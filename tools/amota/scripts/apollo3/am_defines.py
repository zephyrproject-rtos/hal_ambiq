...
#### INTERNAL BEGIN ####
# Change the following to go to advanced image formats with 256b AES support
# AM_SECBOOT_ENC_ALGO_MAX
# helpEncAlgo
# AM_KEK_SIZE
#### INTERNAL END ####
...
#### INTERNAL BEGIN ####
AM_SECBOOT_ENC_ALGO_AES256 = 2
#AM_SECBOOT_ENC_ALGO_MAX  = AM_SECBOOT_ENC_ALGO_AES256 # To be uncommented if AES256 support is needed
#### INTERNAL END ####
AM_SECBOOT_ENC_ALGO_MAX  = AM_SECBOOT_ENC_ALGO_AES128
# String constants
#### INTERNAL BEGIN ####
#helpEncAlgo = 'Encryption Algo? (0(default) = none, 1 = AES128, 2 = AES256)' # To be uncommented if AES256 support is needed
#### INTERNAL END ####
...
AM_IMAGE_MAGIC_AM3P       = 0x3A
AM_IMAGE_MAGIC_PATCH      = 0xAF
#### INTERNAL END ####
...
AM_HMAC_SIG_SIZE                = 32
#### INTERNAL BEGIN ####
#AM_KEK_SIZE                     = 32    # For enahanced formats supporting AES256
#### INTERNAL END ####
AM_KEK_SIZE                     = 16
AM_CRC_SIZE                     = 4
...
#### INTERNAL BEGIN ####
# Offsets in AM Recovery Blob
AM_REC_BLOB_SIZE                = (96 + AM_KEK_SIZE)
AM_REC_BLOB_OFFSET_SIG          = 16
AM_REC_BLOB_OFFSET_IV           = 48
AM_REC_BLOB_OFFSET_KEK          = 64
AM_REC_BLOB_OFFSET_NONCE        = (AM_REC_BLOB_OFFSET_KEK + AM_KEK_SIZE)
AM_REC_BLOB_OFFSET_CUSTID       = (AM_REC_BLOB_OFFSET_NONCE + 16)
AM_REC_BLOB_OFFSET_CIDSTART     = (AM_REC_BLOB_OFFSET_CUSTID + 4)
AM_REC_BLOB_OFFSET_CIDEND       = (AM_REC_BLOB_OFFSET_CIDSTART + 4)

AM_REC_BLOB_START_HMAC       = (AM_REC_BLOB_OFFSET_SIG + AM_HMAC_SIG_SIZE)
AM_REC_BLOB_START_ENCRYPT    = (AM_REC_BLOB_OFFSET_KEK + AM_KEK_SIZE)
#### INTERNAL END ####
...
#******************************************************************************
#
# CRC using ethernet poly, as used by Apollo3 hardware for validation
#
#******************************************************************************
def crc32(L):

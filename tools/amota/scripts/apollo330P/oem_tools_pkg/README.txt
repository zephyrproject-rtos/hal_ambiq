...
This README is just to briefly describe the sample configs bundled with the tooling.
...
After downloading these 2 blobs, the device needs to be reset (POR). After a successful OEM provisioning, device is transitioned to secure LCS.
...
bundled tooling includes couple of sample provisioning configurations, and pregenerated provisioning blobs corresponding to the same as a reference.
...
bundled tooling includes sample configurations as a reference.
